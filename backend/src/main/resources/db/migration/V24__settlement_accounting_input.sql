-- =============================================================================
-- V24: Settlement Accounting Report — admin-entered per-period facts
--
...
--
-- NOTE: originally authored as V23, but V23__payout_type.sql landed first from a
-- sibling branch merged just before this one — renumbered to V24 on merge to
-- avoid a duplicate Flyway version. No other change.
-- =============================================================================
